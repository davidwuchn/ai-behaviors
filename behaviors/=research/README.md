...
- `What are the approaches to real-time sync? #=research #deep`
- `What do I need to know about CRDT vs OT? #=research #first-principles`
- `Investigate why this module has so many dependencies #=research`
- `What's the testing landscape in this project? #=research`
- `#=research #challenge` — investigate while stress-testing findings
- `#=research #decompose` — break complex questions into independent sub-investigations
